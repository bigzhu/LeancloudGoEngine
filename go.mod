...
require (
	github.com/bigzhu/gobz v0.0.17
	github.com/bigzhu/prose v1.1.1-0.20220222103147-2687dbe5219b
...
replace github.com/leancloud/go-sdk v0.3.1 => github.com/bigzhu/go-sdk v0.3.2
